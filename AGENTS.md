...
```text
build/
  extension.js          # bundled from src/extension.ts + src/
...
- `src/extension.ts`: Cinnamon extension lifecycle, initialization, enable/disable wiring.
